...
func NewErrorImpactStore(db *sql.DB) ErrorImpactStore {
...
func (s *errorImpactStore) GetImpact(ctx context.Context, fingerprint string) (*ErrorImpact, error) {
	var ei ErrorImpact
...
func (s *errorImpactStore) GetAffectedUsers(ctx context.Context, fingerprint string, limit int) ([]AffectedUser, error) {
	if limit <= 0 {
		limit = 20
	}
...
func (s *errorImpactStore) GetUserErrors(ctx context.Context, userID string, since time.Time) ([]ErrorSummary, error) {
...
func (s *errorImpactStore) TopByImpact(ctx context.Context, params ImpactQueryParams) ([]ErrorGroupWithImpact, error) {
	...
	var results []ErrorGroupWithImpact
	for rows.Next() {
		var eg ErrorGroupWithImpact
		var firstStr, lastStr string
