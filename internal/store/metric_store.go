...
func (s *metricStore) BatchInsert(ctx context.Context, serverID uuid.UUID, ts time.Time, samples []MetricSample) (int, error) {
	if len(samples) == 0 {
		return 0, nil
	}
...
func (s *metricStore) Query(ctx context.Context, params MetricQuery) ([]MetricPoint, error) {
...
func (s *metricStore) LatestByServer(ctx context.Context, serverID uuid.UUID) ([]MetricPoint, error) {
