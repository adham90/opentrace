...
func NewAgentNoteStore(db *sql.DB) AgentNoteStore {
	return &agentNoteStore{db: db}
}

func (s *agentNoteStore) Upsert(ctx context.Context, entityType, entityID, note string) (*AgentNote, error) {
...
func (s *agentNoteStore) Get(ctx context.Context, entityType, entityID string) (*AgentNote, error) {
...
func (s *agentNoteStore) List(ctx context.Context, entityType string) ([]AgentNote, error) {
	var rows *sql.Rows
	var err error
	if entityType != "" {
