...
func (s *analyticsStore) TopEndpoints(ctx context.Context, params TopEndpointParams) ([]EndpointStat, error) {
...
func (s *analyticsStore) TrafficSummary(ctx context.Context, params AnalyticsParams) (*TrafficSummary, error) {
...
func (s *analyticsStore) TrafficHeatmap(ctx context.Context, service string) ([]HeatmapCell, error) {
