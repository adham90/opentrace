	...
	categories := []toolCategory{
		{
			...
			Tools: []toolInfo{
				...
				{Name: "db_locks", Description: "Show current database locks, blocking chains, and deadlock risks", Access: "read", Requires: "database connector"},
				{Name: "db_index_analysis", Description: "Analyze indexes: find unused, missing, duplicate, and bloated indexes with fix suggestions", Access: "read", Requires: "database connector"},
				{Name: "explain_query", Description: "Run EXPLAIN ANALYZE on a query and return the execution plan with optimization tips", Access: "read", Requires: "database connector"},
				{Name: "connection_pool_stats", Description: "Show connection pool health: utilization, per-application breakdown, and warnings", Access: "read", Requires: "database connector"},
			},
		},
		{
			Name:        "Monitors",
			...
			Tools: []toolInfo{
				...
				{Name: "suggest_monitors", Description: "Analyze system state and suggest monitors to create, with ready-to-use configs", Access: "admin"},
				{Name: "monitor_run_history", Description: "Show execution history for a specific monitor with outcome trends", Access: "read"},
			},
		},
		{
			Name:        "Alerts",
			...
			Tools: []toolInfo{
				...
				{Name: "alert_details", Description: "Get full alert details including triggering run, related alerts, and context", Access: "read"},
			},
		},
		{
			Name:        "Log Intelligence",
			Description: "Analyze log patterns, volumes, and distributed traces",
			Tools: []toolInfo{
				{Name: "log_stats", Description: "Aggregate log statistics by level, service, or pattern with trend detection", Access: "read"},
				{Name: "trace_lookup", Description: "Assemble a distributed trace timeline from log entries by trace ID", Access: "read"},
				{Name: "compare_periods", Description: "Compare error rates, log volume, or alert counts between two time periods", Access: "read"},
			},
		},
		{
			Name:        "Connectors",
