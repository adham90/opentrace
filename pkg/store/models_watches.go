...
// WatchRun represents a single evaluation of a watch. Environment is
// denormalized from the parent Watch at write time so listing runs by env
// avoids a join.
...
// WatchAlert represents an alert generated by a watch breach. Environment is
// denormalized from the parent Watch at write time — notifiers carry it in
// their payload, and querying alerts by env doesn't need a join.
